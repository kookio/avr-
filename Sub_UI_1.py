...
class SubFrame_1(Frame):
    def __init__(self):
        ...
        # worker 생성
        # self.worker_1 = PLC_A()
        # self.worker_2 = CheckPLC_1(self)
        # self.worker_3 = Update_1(self)
        # self.worker_4 = PLC_B()
        # self.worker_5 = CheckPLC_2(self)
        # self.worker_6 = Update_2(self)
    ...
    def btn_cmd_1(self):
        ...
        # 쓰레드는 한번 종료되면 소멸하여 재사용이 안되기 때문에
        # 아예 시작이 될 때마다 새로 만들어주는 것으로 수정 - 장두석
        self.worker_1 = PLC_A()
        self.worker_2 = CheckPLC_1(self)
        self.worker_3 = Update_1(self)
