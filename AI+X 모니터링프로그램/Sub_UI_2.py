...
class SubFrame_2(Frame):
    ...
    def initUI(self):
        ...
        # frame_1 component
        """machine info"""
        machine_name_1 = Label(self, text='PLC_C', font=self.font_25, fg='#FFFFFF', bg=color_frame_bg)
        ...
        self.run_button_off_1 = Button(self, image=self.run_btn_off_image_1_1, bg='#FFFFFF', bd=0, state='disabled', 
        ...
        # frame_2 component
        """machine info"""
        machine_name_2 = Label(self, text='PLC_D', font=self.font_25, fg='#FFFFFF', bg=color_frame_bg)
        ...
        self.run_button_off_2 = Button(self, image=self.run_btn_off_image_2_1, bg='#FFFFFF', bd=0, state='disabled',
    ...
    def btn_cmd_1(self):
        ...
        # self.run_button_on_1.configure(image=self.run_btn_on_image_1_1, state='disabled')
        # self.run_button_off_1.configure(image=self.run_btn_off_image_1_2, state='normal')
    ...
    def btn_cmd_2(self):
        ...
        # self.run_button_off_1.configure(image=self.run_btn_off_image_1_1, state='disabled')
    ...
    def btn_cmd_3(self):
        ...
        # self.run_button_on_2.configure(image=self.run_btn_on_image_2_1, state='disabled')
        # self.run_button_off_2.configure(image=self.run_btn_off_image_2_2, state='normal')
    ...
    def btn_cmd_4(self):
        ...
        # self.run_button_off_2.configure(image=self.run_btn_off_image_2_1, state='disabled')